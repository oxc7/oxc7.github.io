...
export const ROUTES: RouteMeta[] = [
  ...
  },
  {
    ...
    description:
      'Applied AI projects by Chen Yow Ru for investors and operators: an AI Technical Due Diligence Assistant (RAG-grounded diligence memos), an AI Value Creation Roadmap Generator, SafeTracks (an award-winning platform-safety voice system), and an IP Risk Screening Tool.',
    render: () => <Projects />,
  },
  {
    path: '/patents/',
